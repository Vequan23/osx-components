...
.tree { min-width: 0; background: var(--osx-surface-sunken); }label { display: flex; align-items: center; margin: 9px; border: 1px solid var(--osx-border); border-radius: 7px; background: var(--osx-surface-raised); box-shadow: 0 1px 2px rgba(0,0,0,.1) inset; }label span { width: 13px; height: 13px; position: relative; margin-left: 8px; border: 2px solid var(--osx-muted); border-radius: 50%; }label span::after { width: 5px; height: 2px; position: absolute; right: -4px; bottom: -2px; background: var(--osx-muted); content: ""; transform: rotate(45deg); }input { width: 100%; min-width: 0; height: 31px; padding: 5px 8px; border: 0; outline: 0; color: var(--osx-text); background: transparent; font: 12px var(--osx-font); }label:focus-within { outline: 3px solid var(--osx-focus); outline-offset: 1px; }
