...
.state { width: 27px; height: 27px; display: grid; place-items: center; border: 1px solid var(--osx-border); border-radius: 50%; color: var(--osx-muted); background: var(--osx-surface-sunken); font-size: 12px; font-weight: 800; }
