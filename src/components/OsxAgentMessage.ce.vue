...
article { min-width: 0; max-width: 100%; overflow-x: clip; padding: 14px 16px; border-bottom: 1px solid var(--osx-border-soft); background: var(--osx-surface); }
...
.body { padding: 10px 0 0 29px; min-width: 0; overflow-wrap: anywhere; word-break: break-word; font-size: 13px; line-height: 1.58; }
.body :slotted(*) { max-width: 100%; }
