...
header div { display: flex; align-items: center; gap: 8px; color: var(--osx-accent-ink); }header strong { color: var(--osx-text); font-size: 13px; }header > span { min-width: 34px; padding: 2px 7px; border: 1px solid var(--osx-border); border-radius: 999px; color: var(--osx-muted); background: var(--osx-surface-sunken); font-size: 12px; font-weight: 700; text-align: center; }
